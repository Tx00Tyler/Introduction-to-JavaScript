...
function game(userChoice){
  // calc comp choice of rock, paper, scissors
...
function annoyingSong(howmanybottles){
        for (let f = howmanybottles; f >0; f--) {
          return `${f} bottles of soda on the wall, ${f} bottles of soda, take one down pass it around ${(f-1)} bottles of soda on the wall`
        }
  }
